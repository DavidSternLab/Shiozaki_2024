function [] = Fig05_SongTypeRespDiffHist()
% Code for plotting the histogram of the mean difference in ΔF/F between pulse and sine song during song-type transitions for the voxels which changed ΔF/F depending on song type in Fig. 5d,f.
