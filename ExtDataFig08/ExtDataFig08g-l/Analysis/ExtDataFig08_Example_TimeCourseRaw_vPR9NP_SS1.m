function [] = ExtDataFig08_Example_TimeCourseRaw_vPR9NP_SS1()
% Code for plotting the example time courses of delta F/F in Extended Data Fig. 8g.

GT = 'vPR9NP_SS1'; % 3-3-5, 3-4-1, 3-5-2; 6-1-5
...
plot([15 25]+(Target_WithinTrialID-1)*30,[.5 .5],'r','LineWidth',1)
