function [] = Fig06_Example_TimeCourseRaw_pIP10NP()
% Code for plotting the example time courses of delta F/F for pIP10 neurons in Fig. 6c.
...
plot([15 25]+(Target_WithinTrialID-1)*30,[3 3],'r','LineWidth',1)
plot([14 14]+(Target_WithinTrialID-1)*30,[0 1],'k','LineWidth',1)
plot([14 14.5]+(Target_WithinTrialID-1)*30,[0 0],'k','LineWidth',1)
axis off
