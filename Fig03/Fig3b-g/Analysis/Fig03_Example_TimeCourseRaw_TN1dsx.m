function [] = Fig03_Example_TimeCourseRaw_TN1dsx()
% Code for plotting the time courses of delta F/F for TN1 neurons and simultaneously recorded song in Fig. 3b.
...
% heatmap
PlotOrder = [8,11,9,4,16,14,15,3,2,17,5,13,18,19,1,6,7,10,12];
figure('Position',[100,100,150,150])
subplot(3,1,1)
imagesc(F_comb_DFF(PlotOrder,:),[-1,7])
xlim([740,839])
axis off
colorbar
