function [] = Fig08_Plot_InputOutputHist_Single_TN1A1()
% Code for plotting the histogram in Fig. 8e.
...
for FileID=1:size(FileNames,1)
    ...
    set(gca,'TickDir','out','XTick',[1,length(plotData)],'YTick',[0,100,200],'XTickLabel',[],'YTickLabel',[])
    ylim([0 200])
    pbaspect([3,1,1])
    %     axis square
end
