function [] = Fig02_Example_TimeCourseRaw_dPR1TN1A()
% Code for plotting the time courses of delta F/F for a dPR1 (Fig. 2c) and a TN1A (Fig. 2f) neuron.
...
switch GT
    case 'dPR1'
        Target_FileID = 6; % 6 (4, 6)
        Target_ROI = 1;
        Target_Trial = 2;
        Target_WithinTrialID = 2;
        TargetMic = 1;
    case 'TN1SG'
        Target_FileID = 4; % 4 (4, 6)
        Target_ROI = 1;
        Target_Trial = 1;
