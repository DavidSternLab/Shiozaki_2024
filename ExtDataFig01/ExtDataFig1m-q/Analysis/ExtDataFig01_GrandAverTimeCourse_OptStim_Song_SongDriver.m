function [] = ExtDataFig01_GrandAverTimeCourse_OptStim_Song_SongDriver
% Code for plotting the time course of pulse and sine song during optogenetic stimulation of the song driver in Extended Data Fig. 1m.
