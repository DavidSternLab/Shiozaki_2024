function [] = ExtDataFig01_TuningCurve_OptStim_Song
% Code for plotting the tuning curves of pulse and sine songs induced by optogenetics in Extended Data Fig. 1g,i.

GT = 'dPR1_Chr'; % Extended Data Fig. 1g
% GT = 'TN1_Chr'; % Extended Data Fig. 1i
