function [] = ExtDataFig03_Example_TimeCourseRaw_dPR1_IsolatedSong()
% Code for plotting the example trace in Extended Data Fig. 3p.
...
xlim([99 108])
plot([105 108],[3 3],'r','LineWidth',1)
plot([99 99],[0 1],'k','LineWidth',1)
plot([99 99.5],[0 0],'k','LineWidth',1)
axis off
...
TargetRange = find(99<=x1_comb&x1_comb<108);
...
% Ethogram
TargetRange = find(99+(trial-1)*RecDur<=x1&x1<108+(trial-1)*RecDur);

% prediction
Target_prediction = prediction(find(99<=x1&x1<108));
