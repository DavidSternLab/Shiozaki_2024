function [] = ExtDataFig03_BidirRespMod_Normalized()
% Code for plotting the mean change in ΔF/F after song-type transitions relative to ΔF/F before the transitions in Extended Data Fig. 3e,l.
