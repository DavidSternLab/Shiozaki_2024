function [] = ExtDataFig03_AveTimeCourseSongTrans()
% Code for plotting calcium signals and song probabilities during song type transitions in Extended Data Fig. 3d,k.

GT = 'dPR1'; % Extended Data Fig. 3d
% GT = 'TN1SG'; % Extended Data Fig. 3k
...
switch GT
    ...
    case 'TN1SG'
        ...
        Yhori_1 = [0,0];
        Yvert_1 = [0,0.2];
        Ylim_2 = [0.8 1.55]; % 0.9 1.5
        Yhori_2 = [.8 .8];
        Yvert_2 = [.8 1.0];
        Ylim_3 = [1.1 1.85]; %1.1 1.7
end
