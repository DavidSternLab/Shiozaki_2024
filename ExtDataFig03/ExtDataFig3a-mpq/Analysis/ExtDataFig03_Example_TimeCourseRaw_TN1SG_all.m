function [] = ExtDataFig03_Example_TimeCourseRaw_TN1SG_all()
% Code for plotting example traces for TN1A ΔF/F in Extended Data Fig. 3i.
...
Target_WithinTrialID = 6; % 4-4
TargetMic = 1;

Xrange = [(Target_WithinTrialID-1)*30+14 (Target_WithinTrialID-1)*30+23];
