function [] = ExtDataFig04_TuningCurve_OptStim_Song_HighMagSine
% Code for plotting the tuning curves of pulse and sine songs induced by optogenetics in Extended Data Fig. 4b–d.

GT = 'pIP10_Chr'; % Extended Data Fig. 4c
% GT = 'w_LChr'; % Extended Data Fig. 4d
% GT = 'pIP10L_Chr'; % Extended Data Fig. 4b
% GT = 'pIP10L_w'; % Extended Data Fig. 4d
...
pbaspect([1 1 1])
box off
set(gca,'YTick',[0,.1,.2],'XTick',[0,OptStim],'TickDir','out','XTickLabel',[],'YTickLabel',[])
