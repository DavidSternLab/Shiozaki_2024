function [] = ExtDataFig04_AveTimeCourse_OptStim_Song
% Code for plotting the time course of and the proportions of pulse and sine song in Extended Data Fig. 4e,h.
...
for stim=1:3
    ...
    bufPlot = zeros(size(bufAve_sine,1),length(x));
