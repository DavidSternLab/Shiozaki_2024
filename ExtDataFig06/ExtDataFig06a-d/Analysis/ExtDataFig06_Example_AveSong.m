function [] = ExtDataFig06_Example_AveSong()
% Code for plotting images for the example recordings in Extended Data Fig. 6a,c.

GT = 'nsybD'; % Extended Data Fig. 6a
% GT = 'nsyb'; % Extended Data Fig. 6c
